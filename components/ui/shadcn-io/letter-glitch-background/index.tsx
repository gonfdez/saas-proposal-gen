...
export interface LetterGlitchBackgroundProps extends React.HTMLAttributes<HTMLDivElement> {
  glitchColors?: string[];
  glitchSpeed?: number;
...
export const LetterGlitchBackground = forwardRef<HTMLDivElement, LetterGlitchBackgroundProps>(({
  className,
  ...
  // delete domProps.glitchColors;
  // delete domProps.glitchSpeed;
  // delete domProps.centerVignette;
  // delete domProps.outerVignette;
  // delete domProps.smooth;
  // delete domProps.fontSize;
  // delete domProps.charWidth;
  // delete domProps.charHeight;
